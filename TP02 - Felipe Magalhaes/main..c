...
#define MAXINS 10000 //Numero maximo de Memoria de instruções.
...
#define TAML1 128   //Tamanho da memoria cache L1 em KB's, pode ser de 16KB, 32KB, 64KB e 128KB na atualidade. 
#define TAML2 1024  //Tamanho da memoria cache L2 em KB's, pode ser de 256KB, 512KB, 1MB e 2MB na atualidade. 
#define TAML3 12288  //Tamanho da memoria cache L3 em KB's, pode não ter ou ser de 2MB, 3MB, 4MB, 6MB, 8MB, 10MB, 12MB na faixa pra uso domestico.
