...
int main()
{
	int i=0,IR=0,PC=0, MAR1, MAR2, MBR1, MBR2, Tmp1,Tmp2, TmpRAM, total_acessos;
	...
	Tmp2 = L2Hits * 4;
	TmpRAM = RAMHits * 10;
	total_acessos = L1Hits + L2Hits + RAMHits;
	
	cout<<"L1Hits: "<<L1Hits<<endl;
	cout<<"L2Hits: "<<L2Hits<<endl;
	cout<<"RAMHits: "<<RAMHits<<endl;
	cout<<"Total de acessos: "<<total_acessos<<endl;
	cout<<"Tempo: "<< Tmp1 + Tmp2 + TmpRAM<< endl;
